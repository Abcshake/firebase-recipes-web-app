...
function AddEditRecipeForm({handleAddRecipe}) {
    ...
    <form onSubmit={handleRecipeFormSubmit} className="add-edit-recipe-form-container">
        ...
        <div className="top-form-section">
            ...
            <label className="recipe-label input-lable">
                Recipe Name:
            ...
            <label className="recipe-label input-label">
                ...
                >
                    <option value=""></option>
                    <option value="breadsSandwichesandPizza">Bread, Sandwiches, and Pizza</option>
                            ...
                            return (
                                <tr key={ingredient}>
                                    ...
                                    <td className="ingredient-delete-box">
                                        <button type="button"
                                        className="secondary-button ingredient-delete-button">Delete</button>
                                    </td>
                                </tr>
                            )
                        }) : null
